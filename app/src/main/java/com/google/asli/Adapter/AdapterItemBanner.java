...
public class AdapterItemBanner extends RecyclerView.Adapter<AdapterItemBanner.viewHolder>{
    ...
    @NonNull
    @Override
    public AdapterItemBanner.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterItemBanner.viewHolder viewHolder, int i) {
